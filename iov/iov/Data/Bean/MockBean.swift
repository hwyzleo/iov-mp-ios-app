...
func mockLicenseArea() -> [LicenseArea] {
    return [
        LicenseArea.init(provinceCode: "11", cityCode: "", displayName: "北京市"),
        LicenseArea.init(provinceCode: "11", cityCode: "1101", displayName: "市辖区"),
        LicenseArea.init(provinceCode: "12", cityCode: "", displayName: "天津市"),
        LicenseArea.init(provinceCode: "12", cityCode: "1201", displayName: "市辖区"),
        LicenseArea.init(provinceCode: "13", cityCode: "", displayName: "河北省"),
        LicenseArea.init(provinceCode: "13", cityCode: "1301", displayName: "石家庄市"),
        LicenseArea.init(provinceCode: "14", cityCode: "", displayName: "山西省"),
        LicenseArea.init(provinceCode: "14", cityCode: "1401", displayName: "太原市"),
        LicenseArea.init(provinceCode: "15", cityCode: "", displayName: "内蒙古自治区"),
        LicenseArea.init(provinceCode: "15", cityCode: "1501", displayName: "呼和浩特市"),
        LicenseArea.init(provinceCode: "21", cityCode: "", displayName: "辽宁省"),
        LicenseArea.init(provinceCode: "21", cityCode: "2101", displayName: "沈阳市"),
        LicenseArea.init(provinceCode: "22", cityCode: "", displayName: "吉林省"),
        LicenseArea.init(provinceCode: "22", cityCode: "2201", displayName: "长春市"),
        LicenseArea.init(provinceCode: "23", cityCode: "", displayName: "黑龙江省"),
        LicenseArea.init(provinceCode: "23", cityCode: "2301", displayName: "哈尔滨市"),
        LicenseArea.init(provinceCode: "31", cityCode: "", displayName: "上海市"),
        LicenseArea.init(provinceCode: "31", cityCode: "3101", displayName: "市辖区"),
        LicenseArea.init(provinceCode: "32", cityCode: "", displayName: "江苏省"),
        LicenseArea.init(provinceCode: "32", cityCode: "3201", displayName: "南京市"),
        LicenseArea.init(provinceCode: "33", cityCode: "", displayName: "浙江省"),
        LicenseArea.init(provinceCode: "33", cityCode: "3301", displayName: "杭州市"),
        LicenseArea.init(provinceCode: "34", cityCode: "", displayName: "安徽省"),
        LicenseArea.init(provinceCode: "34", cityCode: "3401", displayName: "合肥市"),
        LicenseArea.init(provinceCode: "35", cityCode: "", displayName: "福建省"),
        LicenseArea.init(provinceCode: "35", cityCode: "3501", displayName: "福州市"),
        LicenseArea.init(provinceCode: "36", cityCode: "", displayName: "江西省"),
        LicenseArea.init(provinceCode: "36", cityCode: "3601", displayName: "南昌市"),
        LicenseArea.init(provinceCode: "37", cityCode: "", displayName: "山东省"),
        LicenseArea.init(provinceCode: "37", cityCode: "3701", displayName: "济南市"),
        LicenseArea.init(provinceCode: "41", cityCode: "", displayName: "河南省"),
        LicenseArea.init(provinceCode: "41", cityCode: "4101", displayName: "郑州市"),
        LicenseArea.init(provinceCode: "42", cityCode: "", displayName: "湖北省"),
        LicenseArea.init(provinceCode: "42", cityCode: "4201", displayName: "武汉市"),
        LicenseArea.init(provinceCode: "43", cityCode: "", displayName: "湖南省"),
        LicenseArea.init(provinceCode: "43", cityCode: "4301", displayName: "长沙市"),
        LicenseArea.init(provinceCode: "44", cityCode: "", displayName: "广东省"),
        LicenseArea.init(provinceCode: "44", cityCode: "4401", displayName: "广州市"),
        LicenseArea.init(provinceCode: "45", cityCode: "", displayName: "广西壮族自治区"),
        LicenseArea.init(provinceCode: "45", cityCode: "4501", displayName: "南宁市"),
        LicenseArea.init(provinceCode: "46", cityCode: "", displayName: "海南省"),
        LicenseArea.init(provinceCode: "46", cityCode: "4601", displayName: "海口市"),
        LicenseArea.init(provinceCode: "50", cityCode: "", displayName: "重庆市"),
        LicenseArea.init(provinceCode: "50", cityCode: "5001", displayName: "市辖区"),
        LicenseArea.init(provinceCode: "51", cityCode: "", displayName: "四川省"),
        LicenseArea.init(provinceCode: "51", cityCode: "5101", displayName: "成都市"),
        LicenseArea.init(provinceCode: "52", cityCode: "", displayName: "贵州省"),
        LicenseArea.init(provinceCode: "52", cityCode: "5201", displayName: "贵阳市"),
        LicenseArea.init(provinceCode: "53", cityCode: "", displayName: "云南省"),
        LicenseArea.init(provinceCode: "53", cityCode: "5301", displayName: "昆明市"),
        LicenseArea.init(provinceCode: "54", cityCode: "", displayName: "西藏自治区"),
        LicenseArea.init(provinceCode: "54", cityCode: "5401", displayName: "拉萨市"),
        LicenseArea.init(provinceCode: "61", cityCode: "", displayName: "陕西省"),
        LicenseArea.init(provinceCode: "61", cityCode: "6101", displayName: "西安市"),
        LicenseArea.init(provinceCode: "62", cityCode: "", displayName: "甘肃省"),
        LicenseArea.init(provinceCode: "62", cityCode: "6201", displayName: "兰州市"),
        LicenseArea.init(provinceCode: "63", cityCode: "", displayName: "青海省"),
        LicenseArea.init(provinceCode: "63", cityCode: "6301", displayName: "西宁市"),
        LicenseArea.init(provinceCode: "64", cityCode: "", displayName: "宁夏回族自治区"),
        LicenseArea.init(provinceCode: "64", cityCode: "6401", displayName: "银川市"),
        LicenseArea.init(provinceCode: "65", cityCode: "", displayName: "新疆维吾尔自治区"),
        LicenseArea.init(provinceCode: "65", cityCode: "6501", displayName: "乌鲁木齐市"),
        LicenseArea.init(provinceCode: "71", cityCode: "", displayName: "台湾省"),
        LicenseArea.init(provinceCode: "81", cityCode: "", displayName: "香港特别行政区"),
        LicenseArea.init(provinceCode: "82", cityCode: "", displayName: "澳门特别行政区"),
    ]
}
