//
//  VehicleOrderDetailPage_PrepareDeliver.swift
//  iov
//
...
struct VehicleOrderDetailPage_PrepareDeliver_Previews: PreviewProvider {
    @StateObject static var appGlobalState = AppGlobalState.shared
    static var previews: some View {
        VehicleOrderDetailPage.PrepareDeliver(
