//
//  VehicleOrderDetailPage_PrepareTransport.swift
//  iov
//
...
struct VehicleOrderDetailPage_PrepareTransport_Previews: PreviewProvider {
    @StateObject static var appGlobalState = AppGlobalState.shared
    static var previews: some View {
        VehicleOrderDetailPage.PrepareTransport(
