//
//  VehicleOrderDetailPage_ArrangeProduction.swift
//  iov
//
                ...
                VStack(spacing: 0) {
                    ...
                    HStack(spacing: 16) {
                        ...
                        RoundedCornerButton(
                            ...
                            intent.onTapPayOrder(orderPaymentPhase: 3, paymentAmount: totalPrice - 10000, paymentChannel: "ALIPAY")
                        }
                    }
                    .padding(.horizontal, AppTheme.layout.margin)
                    .padding(.top, 20)
...
struct VehicleOrderDetailPage_ArrangeProduction_Previews: PreviewProvider {
    static var previews: some View {
        VehicleOrderDetailPage.ArrangeProduction(
