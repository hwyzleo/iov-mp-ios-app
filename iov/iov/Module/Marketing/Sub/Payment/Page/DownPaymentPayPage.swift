...
struct DownPaymentPayPage: View {
    @StateObject var container: MviContainer<DownPaymentPayIntentProtocol, any DownPaymentPayModelStateProtocol>
    private var intent: DownPaymentPayIntentProtocol { container.intent }
    private var state: any DownPaymentPayModelStateProtocol { container.model }
    ...
    var body: some View {
        ZStack {
            ...
            VStack(spacing: 0) {
                TopBackTitleBar(titleLocal: "定金支付")
                    .frame(height: 54)
    ...
    private var amountSection: some View {
        VStack(spacing: 8) {
            ...
            if let amount = state.payInfo?.downPaymentAmount {
